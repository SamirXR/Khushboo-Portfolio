      ...
      <div className="max-w-[1100px] mx-auto px-6 md:px-10 py-16 md:py-24">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
            <div className="border-t border-[#ff4ea4] pt-4">
              <p className="text-2xl md:text-3xl font-extralight tracking-tight mb-1">100,000+</p>
              <p className="text-[0.7rem] font-mono tracking-[0.15em] uppercase text-[#ff4ea4]">Pledges on microsite</p>
            </div>
            <div className="border-t border-[#ff4ea4] pt-4">
              <p className="text-2xl md:text-3xl font-extralight tracking-tight mb-1">Nationwide</p>
              <p className="text-[0.7rem] font-mono tracking-[0.15em] uppercase text-[#ff4ea4]">Social &amp; community reach</p>
            </div>
            <div className="border-t border-[#ff4ea4] pt-4">
              <p className="text-2xl md:text-3xl font-extralight tracking-tight mb-1">Open-source</p>
              <p className="text-[0.7rem] font-mono tracking-[0.15em] uppercase text-[#ff4ea4]">Binti became a participatory initiative</p>
            </div>
          </div>
          ...
          <p className="text-[0.9rem] font-light leading-[1.8] text-[#f0f0f0] mb-12">
